...
from .views import (
    ...
    SoilSalinityAssistantView,
    DemandForecastAssistantView,
    InfoAssistantView,
    WeatherCurrentView,
    WeatherForecastView,
    WeatherGeocodeView,
...
urlpatterns = [
    ...
    path("auth/send-verification/", SendEmailVerificationView.as_view(), name="send-email-verification"),
    path("auth/verify-email/", ConfirmEmailVerificationView.as_view(), name="confirm-email-verification"),
    ...
    path("workspaces/<str:pk>/delete/", WorkspaceDeleteView.as_view(), name="workspace-delete-alias"),
    ...
    path("soil-salinity/assistant/", SoilSalinityAssistantView.as_view(), name="soil-salinity-assistant"),
    path("demand-forecast/assistant/", DemandForecastAssistantView.as_view(), name="demand-forecast-assistant"),
    path("info/assistant/", InfoAssistantView.as_view(), name="info-assistant"),
